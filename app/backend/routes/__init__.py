...
from app.backend.routes.research_pipeline import router as research_pipeline_router
...
api_router.include_router(research_pipeline_router, tags=["research-pipeline"])
